...
$_LANG['addfundsmaximum'] = "最高单次充值金额";
$_LANG['addfundsmaximumbalance'] = "最多允许预存";
$_LANG['addfundsmaximumbalanceerror'] = "最高预存金额为";
$_LANG['addfundsmaximumerror'] = "最高充值金额为";
$_LANG['addfundsminimum'] = "最低单次充值金额";
$_LANG['addfundsminimumerror'] = "最低充值金额为";
$_LANG['addmore'] = "添加更多";
...
$_LANG['cartproductaddonsnone'] = "您的产品/服务没有可用的附加服务";
...
$_LANG['clientareacontactsemailsdomain'] = "域名邮件 - 续期通知，注册确认等。";
$_LANG['clientareacontactsemailsgeneral'] = "常规邮件 - 常规公告和密码提醒等。";
$_LANG['clientareacontactsemailsinvoice'] = "账单邮件 - 发票及账单提醒等。";
$_LANG['clientareacontactsemailsproduct'] = "产品邮件 - 订单明细，注册邮件等。";
$_LANG['clientareacontactsemailssupport'] = "支持邮件 - 接收由上级账户创建的所有支持工单副本等。";
...
$_LANG['clientareaerrorlanguage'] = "未提供有效语言";
...
$_LANG['clientarealastupdated'] = "上次更新";
...
$_LANG['networkissueslastupdated'] = "上次更新";
...
$_LANG['sslrenewaldate'] = "续签日期";
$_LANG['sslresendmail'] = "重新发送邮件";
...
$_LANG['pwresetsecurityquestionrequired'] = "由于您设置了安全问题，所以请在下面输入安全问题的答案。";
$_LANG['pwresetsecurityquestionincorrect'] = "您输入的安全问题答案与账户中设置的答案不符";
$_LANG['pwresetsubmit'] = "提交";
$_LANG['pwresetrequested'] = "已发送密码重置请求";
$_LANG['pwresetcheckemail'] = "如果您输入的密码与现有账户相符，那么请查看您的邮件，了解接下来该如何操作。";
...
$_LANG['cancelrequestdomaindesc'] = "您还有一个有效的注册域名与该产品相关联<br/>该域名将于 %s 续签，将按 %s 的价格续签 %s 年。<br /><br />如果您也想取消该域名，并让其在当前注册结束时过期，然后选中下面的复选框。";
...
$_LANG['addfundsdescription'] = "充值金额至账户后，可用于避免大量小额交易并可以自动支付生成的任何新账单。";
...
$_LANG['twoipconnect'] = '连接您的应用';
$_LANG['twoipinstruct'] = '使用 %s 或 %s 之类的身份验证器应用程序，扫描下面的二维码。扫码时遇到问题？请手动输入代码：';
$_LANG['twoipverificationstepmsg'] = '输入应用生成的 6 位代码，验证并完成设置。';
$_LANG['twoipenterauth'] = '请输入验证码';
$_LANG['twoipgoogleauth'] = 'Google 身份验证器';
$_LANG['twoipduo'] = 'Duo';
$_LANG['twoipcodemissmatch'] = "您输入的代码与应输入的代码不符。请重新扫描或重新输入代码，然后重试。";
...
$_LANG['clientAreaSecurityTwoFactorAuthRecommendation'] = "我们建议您启用两步验证，为您的账户提供额外的保障。";
...
$_LANG['orderForm']['reviewDomainAndAddons'] = "请检查您选择的域名和可用于它们的附加服务。";
...
$_LANG['orderForm']['errorNoGateways'] = "没有可用的支付方式，因此无法继续下单";
$_LANG['orderForm']['errorUnavailableGateway'] = "选择的支付方式不可用。请从「付款方式」中选择其它选项。";
$_LANG['orderForm']['requiredField'] = "（必填字段标有 *）";
...
$_LANG['store']['sitelock']['features']['sitelockRiskScore'] = "SiteLock 风险评分";
...
$_LANG['store']['sitelock']['features']['dailySmartScans'] = "每日 SMART 扫描";
$_LANG['store']['sitelock']['features']['autoMalwareRemoval'] = "自动删除恶意软件";
$_LANG['store']['sitelock']['features']['trueshieldProtection'] = "TrueShield 保护";
$_LANG['store']['sitelock']['features']['wordPressScan'] = "WordPress 扫描";
$_LANG['store']['sitelock']['features']['spamBlacklistMonitoring'] = "滥用黑名单监控";
$_LANG['store']['sitelock']['features']['waf'] = "网站应用防火墙";
...
$_LANG['store']['websiteBuilder']['pricing']['free']['headline'] = "尝试 Weebly";
...
$_LANG['fraud']['furtherVal'] = "需要进一步验证才能处理您的订单。单击按钮并按照安全提交过程的步骤进行操作。您将在不到一分钟的时间内完成。";
$_LANG['fraud']['furtherValShort'] = "需要进一步验证。单击按钮并按照提供的步骤操作。";
$_LANG['fraud']['submitDocs'] = "提交文档";
$_LANG['fraud']['submitSuccessMsg'] = "谢谢！文档已提供，将由我们的团队手动审核。";
$_LANG['fraud']['status']['notRequested'] = "未请求";
$_LANG['fraud']['status']['notReviewed'] = "已请求";
$_LANG['fraud']['status']['reviewRequested'] = "已提交";
$_LANG['fraud']['status']['failed'] = "已失败";
...
$_LANG['store']['codeGuard']['adminPreview'] = "您激活的 CodeGuard 计划将显示在此处";
...
$_LANG['generatePassword']['lengthValidationError'] = "请输入长度在 8 到 64 之间的数字";
$_LANG['generatePassword']['pwLength'] = "密码长度";
$_LANG['generatePassword']['generatedPw'] = "密码已生成";
$_LANG['generatePassword']['generateNew'] = "生成新密码";
$_LANG['generatePassword']['copyAndInsert'] = "复制到剪贴板并插入";

$_LANG['setupMandate'] = "设置授权付款";

$_LANG['invoicePaymentPendingCleared'] = "您的付款正在处理中，清算完成后将会自动应用。";
$_LANG['invoicePaymentAutoWhenDue'] = "您的款项将在到期时自动请求支付。";

$_LANG['support']['attachmentsRemoved'] = "已移除，因为工单已关闭";
$_LANG['unpaidInvoiceAlert'] = "您有一个未付的账单。立即支付以避免服务中断。";
$_LANG['overdueInvoiceAlert'] = "您有一个逾期账单。";
$_LANG['payInvoice'] = "支付账单";

$_LANG['close'] = "关闭";
$_LANG['submit'] = "提交";
$_LANG['finish'] = "完成";

$_LANG['twofanowenabled'] = "两步验证已经开启";
$_LANG['twofacurrently'] = "目前已开启两步验证";
$_LANG['enabled'] = "已启用";
$_LANG['disabled'] = "已停用";

$_LANG['copyrightFooterNotice'] = "版权所有 &copy; :year :company 保留所有权利。";

$_LANG['paymentMethods']['title'] = "付款方式";
$_LANG['paymentMethods']['intro'] = "您的付款方式和设置概览。";
$_LANG['paymentMethods']['description'] = "描述";
$_LANG['paymentMethods']['cardDescription'] = "卡片描述";
$_LANG['paymentMethods']['descriptionInput'] = "输入此卡片的名字";
$_LANG['paymentMethods']['fieldRequired'] = "该字段是必填项。";
$_LANG['paymentMethods']['close'] = "关闭";
$_LANG['paymentMethods']['saveChanges'] = "保存更改";

$_LANG['paymentMethods']['addedSuccess'] = "付款方式添加成功";
$_LANG['paymentMethods']['addFailed'] = "付款方式未能成功创建。请重试。";
$_LANG['paymentMethods']['updateSuccess'] = "付款方式更新成功";
$_LANG['paymentMethods']['saveFailed'] = "无法保存对付款方式的更改。请重试。";
$_LANG['paymentMethods']['defaultUpdateSuccess'] = "默认付款方式更新成功";
$_LANG['paymentMethods']['defaultUpdateFailed'] = "无法更新默认付款方式。请重试。";
$_LANG['paymentMethods']['deleteSuccess'] = "付款方式删除成功";
$_LANG['paymentMethods']['deleteFailed'] = "无法删除所选的付款方式。请重试。";
$_LANG['paymentMethods']['addNewCC'] = "添加新的信用卡";
$_LANG['paymentMethods']['addNewBank'] = "添加新的银行账户";
$_LANG['paymentMethods']['name'] = "名字";
$_LANG['paymentMethods']['status'] = "状态";
$_LANG['paymentMethods']['actions'] = "操作";
$_LANG['paymentMethods']['default'] = "默认";
$_LANG['paymentMethods']['setAsDefault'] = "设为默认";
$_LANG['paymentMethods']['edit'] = "编辑";
$_LANG['paymentMethods']['delete'] = "删除";
$_LANG['paymentMethods']['noPaymentMethodsCreated'] = "尚未创建任何付款方式";
$_LANG['paymentMethods']['areYouSure'] = "您确定吗？";
$_LANG['paymentMethods']['deletePaymentMethodConfirm'] = "您确定要删除此付款方式吗？此操作无法恢复。";
$_LANG['paymentMethods']['type'] = "类型";
$_LANG['paymentMethods']['requestCancelled'] = "付款方式请求已取消";
$_LANG['paymentMethods']['retry'] = "重试";
$_LANG['paymentMethods']['creditCardChangesWontBeReflected'] = "您在此处所做的更改将被保存，但在客户中心内查看付款方式时，并非所有更改都会反映出来。";

$_LANG['paymentMethodsManage']['editPaymentMethod'] = "编辑付款方式";
$_LANG['paymentMethodsManage']['addPaymentMethod'] = "新增付款方式";
$_LANG['paymentMethodsManage']['invalidCardDetails'] = "您输入的卡号似乎无效。请重试。";
$_LANG['paymentMethodsManage']['creditCard'] = "信用卡";
$_LANG['paymentMethodsManage']['bankAccount'] = "银行账户";
$_LANG['paymentMethodsManage']['optional'] = "（可选的）";
$_LANG['paymentMethodsManage']['cardNumberNotValid'] = "您输入的卡号似乎无效。";
$_LANG['paymentMethodsManage']['expiryDateNotValid'] = "您输入的失效日期似乎无效。";
...
$_LANG['paymentMethodsManage']['savings'] = "正在保存";
$_LANG['paymentMethodsManage']['accountHolderName'] = "账户持有人姓名";
$_LANG['paymentMethodsManage']['bankName'] = "银行名称";
$_LANG['paymentMethodsManage']['sortCodeRoutingNumber'] = "排序代码/路由号码";
$_LANG['paymentMethodsManage']['routingNumberNotValid'] = "您输入的路由号码似乎无效。";
$_LANG['paymentMethodsManage']['accountNumber'] = "账户号码";
$_LANG['paymentMethodsManage']['accountNumberNotValid'] = "您输入的银行账号似乎无效。";
$_LANG['paymentMethodsManage']['addNewAddress'] = "添加新的地址";
$_LANG['paymentMethodsManage']['addNewBillingAddress'] = "添加新的账单地址";
$_LANG['paymentMethodsManage']['unsupportedCardType'] = "我们无法接受您输入的卡种。请使用其它卡片。";
...
$_LANG['creditCardStore'] = "保存卡片以便在将来快速结账";

$_LANG['support']['ccRecipients'] = "CC 收件人";
$_LANG['support']['addCcRecipients'] = "输入电子邮件地址";
$_LANG['support']['removeRecipient'] = "移除收件人";
$_LANG['support']['successDelete'] = "CC 收件人 :email 已移除";
$_LANG['support']['deleteEmailNotExisting'] = ":email 不是一个 CC 收件人";
$_LANG['support']['addEmailExists'] = ":email 已是 CC 收件人";
$_LANG['support']['successAdd'] = "已添加 CC 收件人 :email";
$_LANG['support']['clientEmail'] = "用户的邮件地址无法添加为 CC 收件人";
$_LANG['support']['emailNotPossible'] = "无法添加 :email 为 CC 收件人";
$_LANG['support']['invalidEmail'] = "输入的电子邮件地址无效。";
$_LANG['support']['ipAddress'] = "IP 地址";

$_LANG['confirmAndPay'] = "确认与支付";
$_LANG['paymentPreApproved'] = ":gateway 预核准付款";
$_LANG['expressCheckoutInfo'] = "您的付款正在等待确认，通常只需要几分钟。如果几分钟后仍未收到确认邮件，请与支持人员联系。";
$_LANG['expressCheckoutError'] = "处理您的付款时遇到一些问题。请联系支持。";

$_LANG['subscription']['active'] = "您有一个激活的订阅";
$_LANG['subscription']['manual'] = "您仍然可以手动付款，但这可能会导致重复付款。";
$_LANG['subscription']['moreDetails'] = "更多详情";
$_LANG['subscription']['makePayment'] = "进行付款";
$_LANG['subscription']['paypalDetails'] = "PayPal 订阅详情";
$_LANG['subscription']['subscriptionWarning'] = "以下任何有效的订阅将自动应用于该账单。如果订阅付款导致重复付款，您将收到一笔抵免额，该抵免额将自动应用于您的下次账单。";
$_LANG['subscription']['subscriptionid'] = "订阅 ID";
$_LANG['subscription']['status'] = "订阅状态";
$_LANG['subscription']['lastpayment'] = "上次付款";
$_LANG['subscription']['nextpaymentdate'] = "下次付款日期";
$_LANG['subscription']['subscriptionstartdate'] = "订阅开始日期";
$_LANG['subscription']['failedpaymentscount'] = "付款失败计数";
...
$_LANG['store']['noDomain'] = "无所需的域名";
$_LANG['store']['noDomainRequired'] = "该产品无所需的域名";
$_LANG['back'] = "返回";

$_LANG['errors']['badRequest'] = "错误的请求";
$_LANG['errors']['badRequestTryAgain'] = "发生意外错误。请重试。";

$_LANG['paymentMethods']['iban'] = "IBAN";
$_LANG['paymentMethods']['mandateAcceptance'] = "通过提供您的 IBAN 并确认此付款，您即授权我们的付款服务提供商 :companyName 和 Stripe 向您的银行发送指令以从您的账户中扣款。根据您与银行达成的协议条款和条件，您有权从银行获得退款。必须从您的账户扣款之日起 8 周内要求退款。";

$_LANG['metrics']['title'] = "按量";
$_LANG['metrics']['explanation'] = "除基本价格外，此产品还包含基于使用情况的计费费用。按量及定价信息如下所示。";
...
$_LANG['metrics']['pricingschema']['simple']['info'] = '此商品的价格结构单一';
$_LANG['metrics']['pricingschema']['simple']['detail'] = '无论数量如何，单价都是一致的。';
$_LANG['metrics']['pricingschema']['grad']['info'] = '此商品具有分级的定价结构。';
$_LANG['metrics']['pricingschema']['grad']['detail'] = '每单位价格是每消费范围。总费用是范围计算的总和。';
$_LANG['metrics']['pricingschema']['flat']['info'] = '此商品的批量定价结构固定。';
$_LANG['metrics']['pricingschema']['flat']['detail'] = '单价由消耗的总量决定。';
$_LANG['metrics']['previousUsage'] = "往期用量";
$_LANG['metrics']['currentUsage'] = "当前用量";
$_LANG['metrics']['lastUpdated'] = "最后更新";
$_LANG['metrics']['metric'] = "按量";
$_LANG['metrics']['billing'] = "账单";
$_LANG['metrics']['includedNotCounted'] = "包含";
...
$_LANG['bankPaymentDeclined'] = "您输入的银行账户信息已被拒绝。请尝试使用其他账户或与支持人员联系。";
$_LANG['invoicePaymentInitiated'] = "感谢！您的扣款已成功发起。付款完成后，您将收到确认电子邮件。";
$_LANG['genericPaymentDeclined'] = "您的款项已被拒绝。请重试或联系支持。";

$_LANG['sitelockvpn']['loginPanelText'] = "登录以设置和管理您的 VPN 用户凭据并下载 VPN 客户端。";
$_LANG['store']['save'] = "节省 :saving%";
$_LANG['marketConnect']['codeguard']['manageBackup'] = "管理备份";
$_LANG['store']['chooseExistingDomain'] = "选择现有域名";
$_LANG['store']['choosePaymentTerm'] = "选择付款条件";
$_LANG['store']['chooseDomain'] = "选择域名";
$_LANG['store']['subOfExisting'] = "现有域名的子域名";
$_LANG['store']['domainAlreadyOwned'] = "我已经拥有一个域名";
...
$_LANG['redirectingToCompleteCheckout'] = "正在重定向以完成结账。请耐心等待…";
...
$_LANG['emailPreferences']['affiliate'] = "推广邮件 - 接收推广邮件通知";
$_LANG['emailPreferences']['domain'] = "域名邮件 - 注册/转移确认和续订通知";
$_LANG['emailPreferences']['general'] = "常规邮件 - 全部账户相关的邮件";
$_LANG['emailPreferences']['invoice'] = "账单邮件 - 新账单、账单提醒和逾期通知";
$_LANG['emailPreferences']['product'] = "产品邮件 - 开通、暂停和其它有关产品的通知";
$_LANG['emailPreferences']['support'] = "支持邮件 - 接收所有支持工单相关的抄送副本";
...
$_LANG['emailPreferences']['oneRequired'] = "您必须至少启用一个电子邮件地址才能接收 ICANN 要求的与域名相关的通知。";
$_LANG['emailPreferences']['domainContactRequired'] = "如需停用域名通知，请为主要账户持有人或其他联系人启用域名通知。";
$_LANG['emailPreferences']['domainClientRequired'] = "如需停用域名通知，请创建一个替代联系人接收通知。";

$_LANG['twoFactor']['duosecurity']['friendlyName'] = "Duo 安全";
$_LANG['twoFactor']['duosecurity']['description'] = "通过 Duo 推送、短信或电话语音接收验证码。";
$_LANG['twoFactor']['totp']['friendlyName'] = "基于时间的令牌";
$_LANG['twoFactor']['totp']['description'] = "从应用获取验证码，例如 Google Authenticator 或 Duo。";
...
$_LANG['store']['emailServices']['tab']['howitworks'] = "运行原理";
$_LANG['store']['emailServices']['tab']['pricing'] = "价格";
$_LANG['store']['emailServices']['tab']['faq'] = "常见问题";
$_LANG['store']['emailServices']['incoming']['title'] = "收件过滤";
$_LANG['store']['emailServices']['outgoing']['title'] = "发件过滤";
$_LANG['store']['emailServices']['archiving']['title'] = "邮件归档";
...
$_LANG['navSwitchAccount'] = "切换账户";
$_LANG['navAccountSecurity'] = "账户安全";

$_LANG['never'] = "从不";

$_LANG['yourProfile'] = "您的个人资料";
$_LANG['verifyEmailAddress'] = '请检查您的电子邮件，然后点击链接以验证您的电子邮件地址。';

$_LANG['emailVerification']['title'] = "邮件验证";
$_LANG['emailVerification']['success'] = "您的电子邮件地址已通过验证";
$_LANG['emailVerification']['expired'] = "您的邮件验证链接已过期";
$_LANG['emailVerification']['notFound'] = "抱歉，我们找不到与您的请求相匹配的验证。";
$_LANG['emailVerification']['loginToRequest'] = "请登录重新发送请求邮件验证链接。";

$_LANG['switchAccount']['title'] = "选择账户";
$_LANG['switchAccount']['choose'] = "选择账户登录或管理";
$_LANG['switchAccount']['noneFound'] = "账户未找到。";
$_LANG['switchAccount']['createInstructions'] = "如需创建新的账户，您需要先下单。";
$_LANG['switchAccount']['noLongerActive'] = "该账户不再有效";
$_LANG['switchAccount']['invalidChooseAnother'] = "请求的账户无效。请选择另一个。";
$_LANG['switchAccount']['cancelAndReturn'] = "取消并返回主页面";
$_LANG['switchAccount']['forcedSwitchRequest'] = "您尝试访问的 URL 要求您以其他用户的身份登录。";
...
$_LANG['userManagement']['userDescriptor'] = "邮件地址 / 上次登录";
$_LANG['userManagement']['lastLogin'] = "上次登录";
$_LANG['userManagement']['actions'] = "操作";
$_LANG['userManagement']['emailAddress'] = "邮件地址";
$_LANG['userManagement']['removeAccess'] = "移除访问权限";
$_LANG['userManagement']['pendingInvites'] = "待接受邀请";
$_LANG['userManagement']['inviteSent'] = "邀请已发送";
$_LANG['userManagement']['resendInvite'] = "重新发送邀请";
$_LANG['userManagement']['cancelInvite'] = "取消邀请";
$_LANG['userManagement']['accountOwnerPermissionsInfo'] = "账户所有者始终对客户账户具有完全权限。";
$_LANG['userManagement']['inviteNewUser'] = "邀请新用户";
$_LANG['userManagement']['inviteEmail'] = "邀请邮件";
$_LANG['userManagement']['inviteNewUserDescription'] = "可以邀请新用户加入您的账户。如果被邀请者为现有的用户账户，则他们将能够使用其已有的登录凭据访问您的账户。如果该用户还没有注册，将会为他们创建一个新的账户。";
$_LANG['userManagement']['allPermissions'] = "所有权限";
$_LANG['userManagement']['choosePermissions'] = "选择权限";
$_LANG['userManagement']['sendInvite'] = "发送邀请";
$_LANG['userManagement']['removeAccessSure'] = "您确定要删除此用户的访问权限吗？";
$_LANG['userManagement']['removeAccessInfo'] = "他们将无法访问或管理本账户。";
$_LANG['userManagement']['cancelInviteSure'] = "您确定要取消该邀请吗？";
$_LANG['userManagement']['cancelInviteInfo'] = "该取消邀请不会通知给该用户。";
$_LANG['userManagement']['permissionsUpdateSuccess'] = "权限更新成功！";
$_LANG['userManagement']['userRemoveSuccess'] = "用户移除成功！";
$_LANG['userManagement']['inviteSentSuccess'] = "邀请发送成功！";
$_LANG['userManagement']['alreadyLinked'] = "输入的电子邮件地址已经是本账户的用户";
$_LANG['userManagement']['alreadyInvited'] = "您输入的电子邮件地址已经有一个激活的邀请。";
$_LANG['userManagement']['inviteResendSuccess'] = "重发邀请成功！";
$_LANG['userManagement']['inviteCancelled'] = "邀请取消成功！";
$_LANG['userManagement']['settings'] = "以下安全设置适用于您的用户账户。";

$_LANG['userProfile']['profile'] = "个人资料";
$_LANG['userProfile']['changeEmail'] = "更改邮件地址";
$_LANG['userProfile']['notVerified'] = "未验证邮件地址";
$_LANG['userProfile']['verified'] = "邮件地址已验证";

$_LANG['accountInvite']['title'] = "接受邀请";
$_LANG['accountInvite']['youHaveBeenInvited'] = "您已经被邀请加入 :clientName";
$_LANG['accountInvite']['givenAccess'] = ":ot:senderName:ct 已授予您访问 :ot:clientName:ct 账户。";
$_LANG['accountInvite']['inviteAcceptLoggedIn'] = "如要接受邀请，请直接点下发的按钮。";
$_LANG['accountInvite']['inviteAcceptLoggedOut'] = "如要接受邀请，请通过下方登录或注册。";
$_LANG['accountInvite']['accept'] = "接受邀请";
$_LANG['accountInvite']['userAlreadyAssociated'] = "您的用户账户已与目标邀请账户关联";
$_LANG['accountInvite']['acceptSuccess'] = "已接受账户邀请！";
$_LANG['accountInvite']['emailAlreadyExists'] = "该电子邮件地址已经被其它账户使用。 请登录或使用其它邮件地址。";
$_LANG['accountInvite']['notFound'] = "抱歉，我们找不到与您的请求相匹配的邀请。";
$_LANG['accountInvite']['contactAdministrator'] = "请联系账户管理员发送新的邀请。";

$_LANG['clientareanavcontacts'] = "联系人";

$_LANG['permissions']['descriptions']['profile'] = "访问和修改客户端配置文件信息";
$_LANG['permissions']['descriptions']['contacts'] = "访问和管理联系人";
$_LANG['permissions']['descriptions']['products'] = "查看产品、服务和附加服务";
$_LANG['permissions']['descriptions']['manageproducts'] = "允许密码重置和其它操作";
$_LANG['permissions']['descriptions']['productsso'] = "允许单点登录服务";
$_LANG['permissions']['descriptions']['domains'] = "查看域名注册";
$_LANG['permissions']['descriptions']['managedomains'] = "允许管理域名，例如：修改域名服务器、修改 WHOIS、转移";
$_LANG['permissions']['descriptions']['invoices'] = "查看和支付账单";
$_LANG['permissions']['descriptions']['quotes'] = "查看并接受报价单";
$_LANG['permissions']['descriptions']['tickets'] = "打开、重新打开并管理支持工单";
$_LANG['permissions']['descriptions']['affiliates'] = "查看并请求结算佣金";
$_LANG['permissions']['descriptions']['emails'] = "查看邮件历史记录";
$_LANG['permissions']['descriptions']['orders'] = "允许下单购买";

$_LANG['closed'] = "已关闭";
$_LANG['noPermission'] = "无权限";

$_LANG['domainDetails']['error']['getNs'] = "检索域名服务器时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['saveNs'] = "更新域名服务器时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['getContact'] = "检索域联系人详细信息时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['saveContact'] = "更新域联系人详细信息时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['getDns'] = "检索 DNS 记录时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['saveDns'] = "更新 DNS 记录时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['getEmailFwd'] = "检索邮件转发时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['saveEmailFwd'] = "更新邮件转发时遇到问题。请联系技术支持。";
$_LANG['domainDetails']['error']['deleteNs'] = "删除私有域名服务器时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['modifyNs'] = "修改私有域名服务器时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['registerNs'] = "注册私有域名服务器时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['saveRegLock'] = "更新域名锁时遇到问题。请联系支持。";
$_LANG['domainDetails']['error']['releaseDomain'] = "释放域名时遇到问题。请检查输入并重试。";
$_LANG['domainDetails']['error']['resendNotification'] = "重新发送通知电子邮件时遇到问题。请联系支持。";
...
$_LANG['cart']['idnLanguageDescription'] = "我们检测到您输入的域名是国际域名。为了继续，请选择您想要的域名语言。";
...
$_LANG['support']['requestor']['authorizeduser'] = "认证用户";
$_LANG['support']['requestor']['registereduser'] = "已注册用户";
$_LANG['support']['requestor']['subaccount'] = "子账户";
$_LANG['support']['requestor']['guest'] = "访客";

$_LANG['twoFactor']['enabled'] = "两步验证已开启";
$_LANG['twoFactor']['disabled'] = "两步验证已停用";
...
$_LANG['orderForm']['downgradeNotPossible'] = "无法降级该产品。请为该服务下新订单。";
...
$_LANG['marketConnect']['siteBuilder']['buildWebsite'] = "搭建您的网站";
$_LANG['store']['siteBuilder']['cartTitle'] = "响应式网站搭建平台";
$_LANG['store']['siteBuilder']['cartShortDescription'] = "将我们的 Site Builder 添加到您的订单中，以创建外观精美的网站、商店或博客。";

$_LANG['clickHere'] = "点击此处";
$_LANG['buy'] = "购买";
$_LANG['viewMore'] = "查看更多…";

$_LANG['store']['siteBuilder']['promo']['sidebar']['title'] = "添加 Site Builder";
