...
$_LANG['cPanel']['addonDomains'] = "附加组件域名";
...
$_LANG['domainDns']['frame'] = "URL框架"; // 建议根据上下文改为“URL结构”或更具体描述
...
$_LANG['store']['nordvpn']['features']['icon']['shield2'] = "阻止烦人的广告、弹出窗口和横幅，并阻止第三方网站跟踪您的在线活动。在所有网站和每台设备上享受更安全、更流畅、更快速的浏览体验。";$_LANG['store']['nordvpn']['features']['icon']['title1'] = "使用VPN，您可以：";
